...
function handleSymbol(value){     // what gonna do when hit symbol
    switch(value){
        case 'C':
            buffer = '0';
            result = 0;
...
function handleNumber(value){  // what gonna do when hit number button
...
function handleButton(value){          //figure out the type of the values and deal with them seperatelly
...
function init() {
    ...
    .addEventListener('click', function(event){     // add eventlistener for clicking
